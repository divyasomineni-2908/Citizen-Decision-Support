      ...
      <div className="p-6 flex-grow">
        <div className="flex justify-between items-start gap-4">
            <div className="flex-shrink-0">
                <div className="text-sm text-secondary font-semibold uppercase tracking-wide">{scheme.category}</div>
        ...
        <h3 className="mt-2 text-xl font-bold text-dark">{t(scheme.id)}</h3>
        <p className="mt-3 text-gray-600 text-sm line-clamp-3">{scheme.description}</p>
      </div>
